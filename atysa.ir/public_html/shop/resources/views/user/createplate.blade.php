  ...
  <div class="container position-relative">
      <div class="row">
        ...
        <div class="col-md-6" style="text-align: left; padding: 20px;">
          <a href="/order" class="font-weight-bold text-decoration-none text-primary">بازگشت به صفحه سفارش></a>
        </div>
      </div>
  </div>
</div>
<div class="container createFoodSection">
  @if(isset(Auth::user()->products))
            ...
            <div class="osahan-card-body border-top p-3">
              <form method="post" action="/user/create-plate" >
                    ...
                    <div class="card w-100">
                      ...
                      <div class="card-body bg-light">
                        <div class="form-group text-left">
                          ...
                          <input
                            oninvalid="this.setCustomValidity('لطفا نام بشقاب را وارد نمایید.')" required 
                            type="text"
                            name="plateName"
                            class="form-control"
                ...
                <div class="row" style="margin-top: 15px;margin-bottom:15px;">
                  <div class="col-12 d-flex justify-content-center">
                    <div class="card w-100">
                      <h5 class="card-header text-center"">خلاصه بشقاب</h5>
                      <div class="card-body px-5">
                        ...
                        <div class="d-flex justify-content-around">
                            <button disabled id="add-final-dish" class="btn btn-success">ذخیره بشقاب شما</button>
...
<script>
  $(document).ready(function(){
    ...
    $('select').change(function(){
      ...
      if(onlinePrice > 50000){
        $('#add-final-dish').removeAttr('disabled');
      }else{
        $('#add-final-dish').attr('disabled','disabled');
      }
    });
    $('select').select2({
      language: {

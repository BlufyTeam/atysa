                ...
                <form class="addToBasketForm">
                    ...
                    <div class="recepie-body">
                        <div class="form-group">
                            <label for="type" class="small font-weight-bold">نوع ارسال</label>
                            <select  class="form-control typeClass" name="type">
                                <option value="1">ارسال طبق برنامه</option>
                                <option value="2">ارسال به روز</option>
                            </select>
                        </div>
                        <div class="form-group dayClass">
                            <label for="day" class="small font-weight-bold">برنامه ارسال این کالا</label>
                            <input required type="text" class="form-control" name="day" id="day" placeholder="انتخاب تاریخ">
                        </div>
                        <div class="container position-relative">
                            <img alt="#" src="" class="restaurant-pic product-image">
                            <div class="pt-3">
                                <h2 class="font-weight-bold product-name"></h2>
                                <p style="width: 65%;" class="m-0 product-description"></p>
    ...
    <script>
        $(document).ready(function(e){
            ...
            $('body').on('click','.addToBasket',function(){
                ...
                if( $('.typeClass').val() == '2' || $('.addToBasketForm input[type="text"]').val().length !== 0){
                    addToBasket($('.addToBasketForm').serialize());
                    $('#extras').modal('toggle');
                }else{
                    $('.addToBasketForm input[type="text"]').focus();
                }

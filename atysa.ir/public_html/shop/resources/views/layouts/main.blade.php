                            ...
                            @else
                                ...
                                <div class="dropdown mr-4 m-none">
                                    <a href="#" class="dropdown-toggle text-dark py-3 d-block" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img alt="#" src="{{ Auth::user()->avatar ? '/'.Auth::user()->avatar :  '/main/img/user1.jpg' }}" class="img-fluid rounded-circle header-user mr-2 header-user"> سلام {{Auth::user()->fullName}}
                                    </a>
                    ...
                    @if(isset(Auth::user()->addresses))
                        ...
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                ...
                                <input oninvalid="this.setCustomValidity('لطفا آدرس وارد نمایید.')" required placeholder="" type="text" class="form-control" name="address">
                            </div>
                            <div class="col-md-12 form-group">
                                <label class="form-label">پلاک و طبقه</label>
                                <div class="input-group">
                                    <input  oninvalid="this.setCustomValidity('لطفا پلاک و طبقه را وارد نمایید.')" required placeholder="" type="area" name="area" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                                ...
                                <input type="radio" name="options" id="option12" value="خانه">خانه
                                    ...
                                    <label class="btn btn-outline-secondary">
                            <input type="radio" name="options" id="option32" value="سایر آدرس ها">سایر آدرس ها
                            </label>
                                </div>
                            </div>
                        </div>

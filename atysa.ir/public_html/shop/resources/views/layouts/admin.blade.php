                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="/admin/categories/all">همه</a></li>
                                    <li><a href="/admin/categories/new">افزودن</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);">
                            ...
                            <li><a href="/admin/orders">سفارش ها</a></li>
                            <li>
                                <a href="javascript: void(0);">
                                    <i class="mdi mdi-view-list"></i>
                                    <span> بنرها </span>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="/admin/banner/all">همه</a></li>
                                    <li><a href="/admin/banner/new">افزودن</a></li>
                                </ul>
                            </li>
                        </ul>

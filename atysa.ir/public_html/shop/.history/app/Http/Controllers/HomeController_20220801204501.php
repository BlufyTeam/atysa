...
class HomeController extends Controller
{
    ...
    public function takeProductsFromCategoryForHomePage(Request $request){
        $products = Product::where('category',$request->name)->get();
        return view('partials.productsforhomepage')->with('products', $products);
    }
    ...
    public function home(){
        $banners = Banner::all();
        $categories = Category::all();
        return view('default')->with('categories', $categories)->with('banners', $banners);
    }
}

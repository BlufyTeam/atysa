...
Route::prefix('admin')->group(function(){
    Route::middleware(['web','auth'])->group(function(){
        ...
        Route::post('/banner/delete'        ,'Admin\UserController@deleteBanner');
        Route::post('/banner/new'           ,'Admin\UserController@newBanner');
        Route::post('/delete/update'        ,'Admin\UserController@createBanner');

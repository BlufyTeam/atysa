...
Route::prefix('admin')->group(function(){
    Route::middleware(['isAdmin','web'])->group(function(){
        ...
        Route::get('/plates/new'            ,'Admin\CategoryController@new');
        Route::get('/plates/all'            ,'Admin\CategoryController@all');
        Route::post('/plates/delete'        ,'Admin\CategoryController@delete');
        Route::post('/plates/create'        ,'Admin\CategoryController@create');
        Route::post('/plates/update'        ,'Admin\CategoryController@update');
    });
});

        ...
        <div class="col-md-4 pt-3 checkout">
            <div class="osahan-cart-item rounded rounded shadow-sm overflow-hidden bg-white sticky_sidebar">
                ...
                <div class="bg-white p-3 clearfix border-bottom">
                    <p class="mb-1">تعداد کل <span class="float-right text-dark">$3140</span></p>
                    <p class="mb-1">مبلغ سفارش <span class="float-right text-dark">$62.8</span></p>
                    <p class="mb-1">هزینه ارسال<span class="text-info ml-1"><i class="feather-info"></i></span><span class="float-right text-dark">$10</span></p>
                </div>
                <div class="p-3">
                ...
                <form class="addToBasketForm">
                    ...
                    <div class="recepie-body">
                        <div class="custom-control custom-radio border-bottom py-2">
                            <input value="شنبه" type="radio" id="customRadio1f" name="day" class="custom-control-input" checked>
                            <label class="custom-control-label" for="customRadio1f">شنبه</label>
                        </div>
                        <div class="custom-control custom-radio border-bottom py-2">
                            <input value="یکشنبه" type="radio" id="customRadio2f" name="day" class="custom-control-input">
                            <label class="custom-control-label" for="customRadio2f">یکشنبه</label>
                        </div>
                        <div class="custom-control custom-radio border-bottom py-2">
                            <input value="دوشنبه" type="radio" id="customRadio3f" name="day" class="custom-control-input">
                            <label class="custom-control-label" for="customRadio3f">دوشنبه</label>
                        </div>
                        <div class="custom-control custom-radio border-bottom py-2">
                            <input value="سه شنبه" type="radio" id="customRadio4f" name="day" class="custom-control-input">
                            <label class="custom-control-label" for="customRadio4f">سه شنبه</label>
                        </div>
                        <div class="custom-control custom-radio border-bottom py-2">
                            <input value="چهارشنبه" type="radio" id="customRadio5f" name="day" class="custom-control-input">
                            <label class="custom-control-label" for="customRadio5f">چهارشنبه</label>
                        </div>
                        <div class="custom-control custom-radio border-bottom py-2">
                            <input value="پنجشنبه"  type="radio" id="customRadio6f" name="day" class="custom-control-input">

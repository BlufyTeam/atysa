                ...
                <form class="addToBasketForm">
                    ...
                    <div class="recepie-body">
                        <div class="form-group">
                            <label for="type" class="small font-weight-bold">ارسال</label>
                        ...
                        <div class="form-group dayClass">
                            ...
                            <input required type="text" class="form-control" name="day" id="day" placeholder="تاریخ رسیدن سفارش">
                        </div>
                        <div class="container position-relative">
    ...
    <script>
        $(document).ready(function(e){
            ...
            $('body').on('change','.typeClass', function(){
                if($(this).val() == '2'){
                    $('.addToBasketForm input[type="text"]').css('display','none');
                }else{
                    $('.addToBasketForm input[type="text"]').css('display','block');
                }
            });
            ...
            $('body').on('click','.addToBasket',function(){
                if($('.addToBasketForm input[type="text"]').val().length !== 0){

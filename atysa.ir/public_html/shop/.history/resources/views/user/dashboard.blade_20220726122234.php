                    ...
                    <div>
                        <form action="my_account.html">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputName1d" value="{{Auth::user()->firstName}}">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputName1">نام خانوادگی</label>
                                <input type="text" class="form-control" id="exampleInputName1" value="{{Auth::user()->familyName}}">
                            </div>
                            <div class="form-group">

...
<div class="offer-section py-4">
  <div class="container position-relative">
      ...
      <div class="pt-3 text-white">
          <h2 class="font-weight-bold">ساخت بشقاب دلخواه</h2>
      </div>
  </div>
</div>
        ...
        <div class="card w-100">
          ...
          <div class="card-body px-5">
            ...
            <div id="total" class="justify-content-between align-items-center mb-5 py-3 px-2 rounded" style="display: none">
              ...
              مجموع کالری : <div class="ingredients-calory"></div>
              مجموع قیمت : <div class="ingredients-price"></div>
...
<script>
  $(document).ready(function(){
    ...
    $('select').change(function(){
      ...
      $("input[name='totalPrice']").val(onlineCalory);
      $("#total .ingredients-price").text(onlineCalory);
    });
    $('select').select2({
      language: {

            ...
            <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden">
                ...
                <div class="bg-white profile-details">
                    ...
                    <a href="contact-us.html" class="d-flex w-100 align-items-center border-bottom px-3 py-4">
                        <div class="left mr-3">
                            <h6 class="font-weight-bold m-0 text-dark">تماس با پشتیبانی <i class="feather-phone bg-primary text-white p-2 rounded-circle mr-2"></i></h6>
                        </div>
                        <div class="right ml-auto">
                            <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                        </div>
                    ...
                    <a href="privacy.html" class="d-flex w-100 align-items-center px-3 py-4">
                        <div class="left mr-3">
                            <h6 class="font-weight-bold m-0 text-dark">
                                 خروج <i class="feather-lock bg-warning text-white p-2 rounded-circle mr-2"></i></h6>
                        </div>
                        <div class="right ml-auto">
                            <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                        </div>

                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($row->type == 1)
                                <a href="/admin/users/admin/{{$row->id}}" class="btn btn-secondary waves-effect waves-light">کاربر ساده بشه</a>
                                @else
                                <a href="/admin/users/admin/{{$row->id}}" class="btn btn-secondary waves-effect waves-light">ادمینش کن</a>
                                @endif

                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($row->type == 1)
                                    <a href="/admin/users/type/2/{{$row->id}}" class="btn btn-secondary waves-effect waves-light">کاربر ساده بشه</a>
                                @else
                                    <a href="/admin/users/type/1/{{$row->id}}" class="btn btn-secondary waves-effect waves-light">ادمینش کن</a>
                                @endif

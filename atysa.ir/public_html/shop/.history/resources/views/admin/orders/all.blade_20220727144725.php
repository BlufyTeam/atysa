                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/orders/single/{{$row->id}}" class="btn btn-secondary waves-effect waves-light">ویرایش</a>
                                <button class="button" class="btn btn-warning waves-effect waves-light">جزئیات بیشتر</button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody> 

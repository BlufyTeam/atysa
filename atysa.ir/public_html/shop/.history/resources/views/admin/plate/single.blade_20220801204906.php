                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <select class="form-control"  id="isPromoted" name="isPromoted">
                                <option @if($single->isPromoted == false) selected="selected" @endif value="false">خیر</option>
                                <option @if($single->isPromoted == false) selected="selected" @endif value="true">بله</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">

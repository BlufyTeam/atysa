...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="page-title mb-0 font-size-18">افزودن غذا</h4>
            ...
            <div class="card-body">
                <form enctype="multipart/form-data" action="/admin/plates/create" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-md-2 col-form-label">سرگروه</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label for="calory" class="col-md-2 col-form-label">کالری </label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" id="calory" name="calory"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="price" class="col-md-2 col-form-label">قیمت به تومان </label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" id="price" name="price"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="size" class="col-md-2 col-form-label">سایز </label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        <label for="endDate" class="col-md-2 col-form-label">مواد اولیه</label>
                        <div class="col-md-10">

<div class="osahan-cart-item rounded rounded shadow-sm overflow-hidden bg-white sticky_sidebar">
        ...
        <div class="gold-members d-flex align-items-center justify-content-between px-3 py-2 border-bottom">
            ...
            <div class="d-flex align-items-center">
                <span class="count-number float-right">
                    <button type="button" data-productId="{{$b->productId}}" data-count="{{$b->count}}" class="changeCount btn-sm left dec btn btn-outline-secondary"> 
                        <i class="feather-minus"></i> 
                    </button>
                    <input class="count-number-input" type="text" readonly="" value="{{$b->count}}">
                    <button type="button" data-productId="{{$b->productId}}" data-count="{{$b->count}}" class="changeCount btn-sm right inc btn btn-outline-secondary"> 
                        <i class="feather-plus"></i> 
                    </button>
                </span>
                <p class="text-gray mb-0 float-right ml-2 text-muted small">{{$b->price}}</p>
            </div>
        </div>
    ...
    <div class="bg-white p-3 clearfix border-bottom">
        <p class="mb-1">مجموع سبد <span class="float-right text-dark">$3140</span></p>
        ...
        <hr>
        <h6 class="font-weight-bold mb-0">رقم پرداختی <span class="float-right">$1329</span></h6>
    </div>
    <div class="p-3">

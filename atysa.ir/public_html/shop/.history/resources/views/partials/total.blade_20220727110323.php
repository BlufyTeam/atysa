<div class="osahan-cart-item rounded rounded shadow-sm overflow-hidden bg-white sticky_sidebar">
    ...
    <div class="bg-white p-3 clearfix border-bottom">
        <p class="mb-1">مجموع سبد <span class="float-right text-dark">{{$total}}</span></p>
        <p class="mb-1">هزینه ارسال<span class="text-info ml-1"><i class="feather-info"></i></span>
            <span class="float-right text-dark">{{$shipping}}</span>
        </p>
        <hr>
        <h6 class="font-weight-bold mb-0">رقم پرداختی <span class="float-right">{{money_format('%i تومان'و$final)}}</span></h6>
    </div>
    <div class="p-3">

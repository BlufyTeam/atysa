        ...
        <div class="gold-members d-flex align-items-center justify-content-between px-3 py-2 border-bottom">
            ...
            <div class="d-flex align-items-center">
                <span class="count-number float-right">
                    <button type="button" data-type="minus" data-productId="{{$b->total}}" class="changeCount btn-sm left dec btn btn-outline-secondary"> 
                        <i class="feather-minus"></i> 
                    </button>
                    <input class="count-number-input" type="text" readonly="" value="{{$b->count}}">
                    <button type="button" data-type="plus" data-productId="{{$b->total}}" class="changeCount btn-sm right inc btn btn-outline-secondary"> 

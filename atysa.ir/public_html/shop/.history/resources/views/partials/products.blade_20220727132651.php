<div class="shadow-sm rounded bg-white mb-3 overflow-hidden">
            ...
            <div class="">
                ...
                <div class="p-3 border-bottom menu-list">
                    <span class="float-right">
                        <a href="#" data-id="{{$product->_id}}" class="btn btn-outline-secondary btn-sm addToBasketButton" data-toggle="modal" data-target="#extras">افزودن</a>
                    </span>
                    <div class="media">
                        <img src="{{$product->image}}" class="mr-3 rounded-pill ">
                        <div class="media-body">
                            <h6 class="mb-1">{{$product->name}} </h6>
                            <p class="text-muted mb-0">{{$product->price}} تومان</p>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    @else
    <div class="col-md-12 px-0 border-top">
        <a href="btn btn-success btn-lg" href="/user/plates">بشقاب شخصی خود را بسازید</a>
    </div>
    @endif
</div>
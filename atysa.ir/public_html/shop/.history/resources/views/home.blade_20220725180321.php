    ...
    <div class="cat-slider">
        @foreach($categories as $category)
            <div class="cat-item px-1 py-3">
                <a class="bg-white rounded d-block p-2 text-center shadow-sm" href="#" onClick="changeCategory({{$category->name}})">
                    <img alt="#" src="/upload/categoies/{{$category->image}}" class="img-fluid mb-2">

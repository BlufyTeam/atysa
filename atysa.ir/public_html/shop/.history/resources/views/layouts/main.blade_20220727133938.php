                    ...
                    <aside class="col-md-4 footer-about">
                        <article class="d-flex pb-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted">آتیسا با ارائه و توسعه سیستم یکپارچه سفارش غذای شرکتی اولین کترینگ ارائه کننده غذای رژیمی و سازمانی آنلاین در این عرصه می باشد.که کیفیت غذاهای خود را تضمین می کند.
                                </p>

                            ...
                            @else
                                ...
                                <div class="dropdown mr-4 m-none">
                                    <a href="#" class="dropdown-toggle text-dark py-3 d-block" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <img alt="#" src="/main/img/user/1.jpg" class="img-fluid rounded-circle header-user mr-2 header-user"> سلام Osahan
                                    </a>
                ...
                <div class="modal-body">
                    <form class="">
                        <div class="form-row">
                            ...
                            <div class="col-md-12 form-group"><label class="form-label">آدرس کامل</label><input placeholder="Complete Address e.g. house number, street name, landmark" type="text" class="form-control"></div>

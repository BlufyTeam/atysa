                ...
                <div class="row pt-3">
                    ...
                    <aside class="col-sm-3 col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            <li> <a href="not-found.html" class="text-muted">کترینگ سازمانی</a></li>
                            <li> <a href="maintence.html" class="text-muted">غذای شرکتی</a></li>
                            <li> <a href="coming-soon.html" class="text-muted">سفارش آنلاین غذای سازمانی</a></li>
                        </ul>
                    </aside>
                    <aside class="col-sm-3 col-md-2 text-white">

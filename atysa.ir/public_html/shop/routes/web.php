...
Route::get('/takeproducts'                  , 'HomeController@takeProductsFromCategoryForHomePage');
...
Route::get('/payment/verify'                , 'User\OrderController@verifyPayment')->name('payment.verify');
//'isAdmin',

Route::prefix('admin')->group(function(){
    Route::middleware(['web','auth'])->group(function(){
        Route::get('/banner/all'            ,'Admin\GeneralController@allBanners');
        Route::get('/banner/new'            ,'Admin\GeneralController@newBanner');
        Route::post('/banner/delete'        ,'Admin\GeneralController@deleteBanner');
        Route::post('/banner/create'        ,'Admin\GeneralController@createBanner');
        ...
        Route::get('/users/type/{type}/{id}','Admin\UserController@makeAdmin');
        ...
        Route::get('/orders/single/{id}'    ,'Admin\OrderController@single');
